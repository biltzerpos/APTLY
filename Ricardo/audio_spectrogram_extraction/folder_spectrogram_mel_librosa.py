##########
### This script is used to generate a mel spectrogram 
...
## For loop to go through the folder and calculate the mel
for path in pathlist:
    path_in_str = str(path)
    print(path_in_str)
    y,sr = librosa.load(path_in_str)
    librosa_matrix = librosa.feature.melspectrogram(y=y,sr=sr,n_mels=128,fmax=8000)

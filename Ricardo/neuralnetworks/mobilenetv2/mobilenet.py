...
img_width = 224 #192 #500 #256 
img_height = 224 #192 #121 #256, 256
...
model = applications.mobilenet.MobileNet(weights = "imagenet", include_top=False, input_shape = (img_height,img_width, 3))

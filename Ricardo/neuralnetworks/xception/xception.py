...
img_width = 87 #400 #256 
img_height = 128 #257 #121 #256, 256
...
####Choosing the model
model = Xception(weights = "imagenet", include_top=False, input_shape = (img_height,img_width, 3))


# Freeze the layers which you don't want to train.
for layer in model.layers:
    layer.trainable = False #Freezing the whole thing, just leaving the top fully-connected layers to re-train

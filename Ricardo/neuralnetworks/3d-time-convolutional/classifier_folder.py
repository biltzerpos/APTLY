### ATTENTION: This ios a BETA version. 
### Although it works, the classification accuracy still not the best
...
#Layer1
model.add(Conv2D(32,(3,512), input_shape=(img_width, img_height, 3))) #32 filters of 3x3 size
